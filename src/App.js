  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path='/details/:id' element={<Details toLocalStorage={toLocalStorage} oneProduct={oneProduct} getOneProduct={getOneProduct} deletePizza={deletePizza} getPizzas={getPizzas} />} />
        <Route path='/edit-form/:id' element={<EditForm oneProduct={oneProduct} getOneProduct={getOneProduct} updateProduct={updateProduct} />} />
        <Route path='cart' element={<Cart getCart={getCart} cart={cart} deleteCart={deleteCart} />} />
